...
public class AplicacionImc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(255, 253, 252));
        jLabel1.setText("Introduce tu peso:");

        jLabel2.setFont(new java.awt.Font("Comic Sans MS", 0, 11)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 253, 252));
    ...
    private void calcularImcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularImcActionPerformed
        ...
        Imc i = new Imc();
        i.calcularImc(p);
        JOptionPane.showConfirmDialog(this,"Su Imc es de " + i.valor + " Kg/m");
